...
if (function_exists('register_sidebar')){
	register_sidebar( array(
		...
		'before_title'  => '<h3 class="widget-title"><i class="iconfont icon-viewdashboard"></i>',
		'after_title'   => '</h3>',
	) );
	register_sidebar( array(
		'name'          => '首页侧边栏（跟随）',
...
function md_scripts() {
	...
	if ( is_home() || is_category() ){	
		wp_enqueue_script( 'seria', get_template_directory_uri() . '/inc/slider/jquery.seria.min.js', array(),false );
		wp_enqueue_style( 'slider-css', get_template_directory_uri() . '/inc/slider/slider.css', array(), version);		
		}
	if ( is_singular() ) {
...
/* 头像改用CN、多说gravatar服务器、SSL链接 */
function md_get_avatar($avatar) {
    if(md_get_option('gravatar_source')=='duoshuo'){
    $avatar = str_replace(array("www.gravatar.com", "0.gravatar.com", "1.gravatar.com", "2.gravatar.com" ) , "gravatar.duoshuo.com", $avatar);
    }
	elseif(md_get_option('gravatar_source')=='default'){
...
// 评论等级
	function get_author_class($comment_author_email,$user_id){
		...
		if($author_count>=0 && $author_count<2)
			echo '<a class="vip0" title="评论达人 VIP.0"><i class="iconfont icon-vimeo"></i><span class="lv">0</span></a>';
		else if($author_count>=2 && $author_count<5)
			echo '<a class="vip1" title="评论达人 VIP.1"><i class="iconfont icon-vimeo"></i><span class="lv">1</span></a>';
		else if($author_count>=5 && $author_count<10)
			echo '<a class="vip2" title="评论达人 VIP.2"><i class="iconfont icon-vimeo"></i><span class="lv">2</span></a>';
		else if($author_count>=10 && $author_count<20)
			echo '<a class="vip3" title="评论达人 VIP.3"><i class="iconfont icon-vimeo"></i><span class="lv">3</span></a>';
		else if($author_count>=20 && $author_count<50)
			echo '<a class="vip4" title="评论达人 VIP.4"><i class="iconfont icon-vimeo"></i><span class="lv">4</span></a>';
		else if($author_count>=50)
			echo '<a class="vip5" title="评论达人 VIP.5"><i class="iconfont icon-vimeo"></i><span class="lv">5</span></a>';
	}

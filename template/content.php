	...
	<?php if ( ! is_single() ) : ?>
		<div class="art-desc">
			...
			<div class="more">
				...
				<?php if ( is_sticky() ) { ?><a href="#">置顶</a><?php } ?>	
			</div>
			<div class="clear"></div>
		...
		<div class="art_ft">
			<div class="art-pub">
				...
				<div class="cmnt">
					<?php comments_popup_link( '<i class="iconfont icon-messageprocessing"></i> 发表评论', '<i class="iconfont icon-messageprocessing"></i> 1 ', '<i class="iconfont icon-messageprocessing"></i> %' ); ?>
				</div>
			</div>
	...
	<?php if ( is_single() ) : ?>	
		<header class="entry-header">							
			<div class="single-meta">				
				...
				<span><?php comments_popup_link( '<i class="iconfont icon-messageprocessing"></i> 发表评论', '<i class="iconfont icon-messageprocessing"></i> 1 ', '<i class="iconfont icon-messageprocessing"></i> %' ); ?></span>
		...
		<div class="single-content">
			<?php if ( has_excerpt() ) { ?><span class="abstract"><span><i class="iconfont icon-file-text-o"></i>&nbsp;内容预览</span></br><?php the_excerpt() ?><div class="clear"></div></span><?php }?>
